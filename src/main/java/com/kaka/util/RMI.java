...
public final class RMI {
     ...
     */
    public static <T extends Remote> void publishRemoteService(String host, int port, String name, T serviceObject) throws RemoteException, MalformedURLException {
     ...
     */
    public static <T extends Remote> T lookupRemoteService(String host, int port, String name) throws NamingException, RemoteException, NotBoundException {
